...
class ManualOverrideLogs extends Component {
  state = {
    title: "Manual Override Logs",
    url: "/api/logs/",
    search_keyword: "",
    errors: {},
    dates: [],
  ...
  onSearch = e => {
    ...
    axios
      .post(`${this.state.url}/manual-override`, form_data)
      .then(response =>
        this.setState({
...
export default connect(mapToState)(ManualOverrideLogs);
