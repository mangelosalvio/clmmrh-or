...
class ManualSwitchLogs extends Component {
  state = {
    title: "Recorded Audio Logs",
    url: "/api/logs/",
    search_keyword: "",
    errors: {},
    dates: [],
  ...
  onSearch = e => {
    ...
    axios
      .post(`${this.state.url}/manual-trigger`, form_data)
      .then(response =>
        this.setState({
...
export default connect(mapToState)(ManualSwitchLogs);
