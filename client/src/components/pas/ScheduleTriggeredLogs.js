...
class ScheduleTriggeredLogs extends Component {
  state = {
    title: "Schedule Trigger Logs",
    url: "/api/logs/",
    search_keyword: "",
    errors: {},
    dates: [],
  ...
  onSearch = e => {
    ...
    axios
      .post(`${this.state.url}/schedule-trigger`, form_data)
      .then(response =>
        this.setState({
...
export default connect(mapToState)(ScheduleTriggeredLogs);
