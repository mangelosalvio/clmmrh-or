...
class ResearchCategoriesForm extends Component {
  state = {
    title: "Faculty Research Program",
        ...
        <div className="columns is-marginless">
          <div className="column">
            <Breadcrumb style={{ margin: "16px 0" }}>
              ...
              <Breadcrumb.Item>Resarch Categories</Breadcrumb.Item>
            </Breadcrumb>
          </div>
          <div className="column">
            <Searchbar
...
export default connect(mapToState)(ResearchCategoriesForm);
