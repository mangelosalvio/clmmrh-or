...
const collection_name = "presentation_categories";
...
class PresentationCategoriesForm extends Component {
  state = {
    title: "Presentation Categories",
    url: "/api/presentation-categories/",
    search_keyword: "",
    ...form_data
  };
        ...
        <div className="columns is-marginless">
          <div className="column">
            <Breadcrumb style={{ margin: "16px 0" }}>
              ...
              <Breadcrumb.Item>Presentation Categories</Breadcrumb.Item>
            </Breadcrumb>
          </div>
          <div className="column">
            <Searchbar
...
export default connect(mapToState)(PresentationCategoriesForm);
