...
class AttachmentCategoriesForm extends Component {
  state = {
    title: "Attachment Categories",
    url: "/api/attachment-categories/",
    search_keyword: "",
    ...form_data
  };
        ...
        <div className="columns is-marginless">
          <div className="column">
            <Breadcrumb style={{ margin: "16px 0" }}>
              ...
              <Breadcrumb.Item>Attachment Categories</Breadcrumb.Item>
            </Breadcrumb>
          </div>
          <div className="column">
            <Searchbar
...
export default connect(mapToState)(AttachmentCategoriesForm);
